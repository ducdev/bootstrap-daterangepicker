...
(function (root, factory) {
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function(side) {
            ...
            var arrow = this.locale.direction == 'ltr' ? {left: 'chevron icon left', right: 'chevron icon right'} : {left: 'chevron icon right', right: 'chevron icon left'};
        ...
        calculateChosenLabel: function () {
            ...
            for (var range in this.ranges) {
              if (this.timePicker) {
                    var format = this.timePickerSeconds ? "YYYY-MM-DD hh:mm:ss a" : "YYYY-MM-DD hh:mm a";
